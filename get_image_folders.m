function folders = get_image_folders(destination)
    ...
    sigmfCommsPath = fullfile('Radio Data', 'Training', 'CommSignal3'); % sprintf(basefmt, basePath, 'CommSignal3');
    ...
    folderCommsPath = fullfile("Images", destination, 'CommSignal3'); % sprintf(pathfmt, destination, 'CommSignal3');
