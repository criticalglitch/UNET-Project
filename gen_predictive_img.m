function gen_predictive_img(testPath, unetParams, imgSize, classNames)
    ...
    overlayed = transform(combined, @(x) labeloverlay(x{1}, categorical(x{2}, 1:length(classNames), classNames), IncludedLabels=[ "Signal" ], Transparency=0.5));  % Create overlay image from the two cell arrays
